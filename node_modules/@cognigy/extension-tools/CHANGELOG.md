...
- Added `upsertKnowledgeSource` API to create or update a knowledge source, enabling syncing of knowledge sources using knowledge connectors (Cognigy.AI 2026.5.0 and up).
- Added `sources` field to knowledge connector function params, providing a list of knowledge sources created in previous runs by the currently running connector

### Deprecated

- `createKnowledgeSource` is deprecated in favour of `upsertKnowledgeSource`, which handles both creation and updates
